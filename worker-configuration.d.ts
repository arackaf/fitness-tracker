/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76d449319e0daecadcfa6a5fd475dfca)
...
interface __BaseEnv_Env {
  ...
  WorkoutTemplateAIGenerationDO: DurableObjectNamespace<import("./src/server").WorkoutTemplateAIGenerationDO>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/server");
    durableNamespaces: "WorkoutTemplateAIGeneration";
  }
