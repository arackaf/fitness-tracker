...
export const relations = defineRelations(schema, r => ({
  ...
  exercises: {
    workoutSegments: r.many.workoutSegment({
      ...
      to: r.workoutSegment.id.through(r.workoutSegmentExercise.workoutSegmentId),
    }),
  ...
  workoutSegmentExercise: {
    workoutSegmentExerciseMeasurements: r.many.workoutSegmentExerciseMeasurement(),
  },
  workoutTemplateSegment: {
    ...
    exercises: r.many.exercises({
      from: r.workoutTemplateSegment.id.through(r.workoutTemplateSegmentExercise.workoutTemplateSegmentId),
  ...
  workoutTemplateSegmentExerciseMeasurement: {
    workoutTemplateSegmentExercise: r.one.workoutTemplateSegmentExercise({
      from: r.workoutTemplateSegmentExerciseMeasurement.workoutTemplateSegmentExerciseId,
      to: r.workoutTemplateSegmentExercise.id,
    }),
  },
  workoutTemplateSegmentExercise: {
    workoutTemplateSegmentExerciseMeasurements: r.many.workoutTemplateSegmentExerciseMeasurement(),
  },
}));
