        ...
        <div className="relative mt-2 flex min-h-48 flex-col gap-4 min-w-0">
              ...
              {workoutTemplates.map(template => (
                ...
                >
                  ...
                  {template.description ? (
                    <span className="text-muted-foreground text-left w-full truncate">{template.description}</span>
                  ) : null}
                </Button>
              ))}
            </div>
          ...
          <div className="flex gap-2">
            <Button
              ...
              variant="outline"
              disabled={page === 1}
              className={cn("self-start", page === 1 ? "cursor-not-allowed" : "cursor-pointer")}
            >
              Previous Page
            </Button>
            ...
            <Button
              ...
              className={cn("self-start", !hasNextPage ? "cursor-not-allowed" : "cursor-pointer")}
            >
              Next Page
            </Button>
          </div>
